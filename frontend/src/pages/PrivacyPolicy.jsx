      ...
      <section className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-6 bg-gradient-to-br from-emerald-600 via-emerald-500 to-lime-500 overflow-hidden">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Comprehensive guide to how HillersonsDesigns protects, uses, and
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  At <strong>Hillersons Investment Company Ltd</strong>{" "}
                  ("HillersonsDesigns", "we", "our", or "us"), we understand
                  that your privacy is fundamental to building trust. This
                  comprehensive Privacy Policy outlines exactly how we collect,
                  use, protect, and manage your personal information when you
                  interact with our website, purchase our architectural designs,
                  or use our services.
                </p>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-lime-500 rounded-full flex items-center justify-center text-white font-bold">
              1
            </div>
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  Your data is only shared in specific, limited circumstances
                  outlined below, and always with appropriate safeguards in
                  place.
                </p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Secure payment gateways like Stripe, PayPal, and bank processors to handle transactions safely.",
                  safeguards: [
                    "PCI DSS compliant",
                ...
                },
                {
                  ...
                  description:
                    "Hosting providers and cloud services that store and deliver our content securely.",
                  safeguards: [
                    "SOC 2 certified",
                    "GDPR compliant",
                ...
                },
                {
                  ...
                  description:
                    "Tools like Google Analytics to understand website usage and improve user experience.",
                  safeguards: [
                    "Anonymized data",
                    "IP address masking",
                    "Opt-out available",
                ...
                },
                {
                  ...
                  description:
                    "Government agencies or courts when required by law or to protect our legal rights.",
                  safeguards: [
                    "Valid legal process",
                    "Narrow scope",
          ...
          <div className="mt-8 bg-gradient-to-r from-emerald-50 to-lime-50 rounded-2xl p-8 border border-emerald-200">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  While we implement industry-leading security measures, no
                  online service can guarantee 100% security. We encourage users
                  to use strong, unique passwords and enable two-factor
                  authentication where available. If you suspect any security
                  breach, please contact us immediately at{" "}
                  <strong>security@hillersons.com</strong>.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                  ...
                  <div className="lg:w-80">
                    <div className="bg-gradient-to-r from-emerald-50 to-lime-50 rounded-xl p-4 border border-emerald-200">
                      <span className="text-sm font-medium text-emerald-700 uppercase tracking-wide mb-1 block">
                        How to Exercise:
                      </span>
        ...
        <div className="mb-16">
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-lime-600 rounded-2xl p-8 sm:p-10 text-white">
            ...
            <p className="text-white/90 leading-relaxed mb-8">
              Our dedicated privacy team is here to help. Whether you have
              questions about this policy, want to exercise your rights, or need
              assistance with your account, we're ready to assist.
            </p>
        ...
        <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-lg border border-gray-100">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed mt-6">
              ...
              your acceptance of the updated policy. If you disagree with
              changes, you may close your account and discontinue use of our
              services.
            </p>
          </div>
        </div>
