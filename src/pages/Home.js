    ...
    <div className="bg-gradient-to-b from-emerald-50 via-lime-50 to-white overflow-x-hidden">
      ...
      >
        ...
        <div className="container mx-auto px-4 pt-8 pb-24 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              {/* free Badge */}
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-lime-500/20 to-emerald-500/20 backdrop-blur-xl rounded-full px-6 py-3 mb-8 border border-lime-300/30">
                <Diamond className="w-5 h-5 text-lime-300 animate-pulse" />
                <span className="text-sm font-semibold text-lime-200 tracking-wide">
              ...
              {/* Enhanced Subtitle */}
              <p className="text-xl text-emerald-100 mb-10 leading-relaxed font-light">
              ...
              <div className="flex flex-col sm:flex-row gap-6 mb-12">
                <Link
                  to="/Allproducts"
                  className="group relative bg-gradient-to-r from-lime-500 to-emerald-500 hover:from-lime-400 hover:to-emerald-400 text-white px-10 py-5 rounded-2xl font-bold text-lg transition-all duration-500 shadow-2xl hover:shadow-lime-500/50 hover:scale-105 transform overflow-hidden"
                >
                ...
                <button
                  ...
                  className="group bg-white/10 backdrop-blur-xl hover:bg-white/20 text-white px-10 py-5 rounded-2xl font-bold text-lg transition-all duration-500 border border-white/30 hover:border-lime-300/50 flex items-center justify-center gap-3"
                >
                ...
                {[
                  ...
                  <div key={index} className="text-center group cursor-pointer">
                    <div className="flex items-center justify-center mb-2">
                      <stat.icon className="w-6 h-6 text-lime-300 mr-2 group-hover:scale-110 transition-transform" />
                      <div className="text-3xl font-bold bg-gradient-to-r from-lime-300 to-emerald-300 bg-clip-text text-transparent">
                        {stat.value}
                      </div>
                    </div>
            ...
            <div className="relative lg:ml-8">
              {/* Main showcase card */}
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl hover:shadow-lime-500/20 transition-all duration-700 transform hover:scale-105">
                <div className="relative overflow-hidden rounded-2xl">
                  ...
                  {/* Floating info cards */}
                  <div className="absolute top-4 left-4 bg-white/90 backdrop-blur rounded-xl px-4 py-2 shadow-lg">
                  ...
                  <div className="absolute top-4 right-4 bg-lime-500 text-emerald-900 px-4 py-2 rounded-xl shadow-lg">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur rounded-xl p-4 shadow-lg">
                    ...
                    <div className="flex items-center justify-between text-sm text-emerald-700">
                      ...
                      <span className="flex items-center gap-1">
                        <Square className="w-4 h-4" /> 2,500 ft²
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 120" className="w-full h-20 fill-emerald-50">
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-50 to-lime-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="inline-block bg-gradient-to-r from-emerald-600 to-lime-600 bg-clip-text text-transparent font-semibold text-lg mb-4">
              EXPLORE BY CATEGORY
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories.map((category, index) => (
              <div
                key={index}
                className="group relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-lime-500/25 transition-all duration-700 transform hover:scale-105 cursor-pointer"
              ...
              >
                <div className="relative h-64">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6">
                    ...
                    <p className="text-emerald-100 font-medium opacity-90 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 delay-100">
                      {category.count} Designs Available
                    </p>
                  </div>

                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur rounded-full px-3 py-1 shadow-lg">
                    <span className="text-sm font-bold text-emerald-900">
                      {category.count}+
                    </span>
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {FEATURES.map((feature, index) => (
              <div
                key={index}
                className="group relative bg-gradient-to-br from-emerald-50 to-lime-50 rounded-3xl p-8 hover:shadow-2xl transition-all duration-700 transform hover:scale-105 border border-emerald-100 hover:border-lime-300"
              >
                <div className="relative mb-6">
                  <div className="w-16 h-16 bg-gradient-to-r from-emerald-500 to-lime-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                    <feature.icon className="w-8 h-8 text-white" />
                  </div>
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-lime-400 rounded-full animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                </div>

                <h3 className="text-xl font-bold text-emerald-900 mb-4 group-hover:text-lime-600 transition-colors duration-500">
                  {feature.title}
                </h3>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-lime-500/5 to-emerald-500/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="featured-plans" className="container mx-auto px-4 py-20">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16">
          <div className="max-w-2xl">
            <span className="inline-block bg-gradient-to-r from-amber-500 to-orange-500 text-white px-6 py-3 rounded-full text-sm font-bold mb-6 shadow-lg">
              ⭐ FREE SELECTION
            </span>
            <h2 className="text-4xl md:text-5xl font-bold text-emerald-900 mb-6">
              Featured{" "}
          ...
          <Link
            to="/allProducts"
            className="group flex items-center gap-3 bg-gradient-to-r from-emerald-600 to-lime-600 hover:from-emerald-700 hover:to-lime-700 text-white px-8 py-4 rounded-2xl font-bold mt-8 md:mt-0 transition-all duration-500 shadow-xl hover:shadow-lime-500/25 transform hover:scale-105"
          >
        ...
        {!loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {featuredPlans.map((plan, index) => (
              <div
                key={plan.id}
                className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-700 transform hover:scale-105 overflow-hidden border border-emerald-100 hover:border-lime-300"
              ...
              >
                ...
                <div className="relative">
                  ...
                  {/* Floating free badge */}
                  <div className="absolute top-4 left-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg opacity-0 group-hover:opacity-100 transform -translate-y-2 group-hover:translate-y-0 transition-all duration-500">
                    PREMIUM
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="col-span-3 text-center text-emerald-600 text-xl py-12">
      ...
      <section className="bg-gradient-to-br from-emerald-50 to-lime-50 py-20">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16">
            <div className="max-w-2xl">
              <span className="inline-block bg-gradient-to-r from-lime-500 to-emerald-500 text-white px-6 py-3 rounded-full text-sm font-bold mb-6 shadow-lg flex items-center gap-2">
                <TrendingUp className="w-4 h-4" />
                TRENDING NOW
              </span>
              <h2 className="text-4xl md:text-5xl font-bold text-emerald-900 mb-6">
            ...
            <Link
              to="/allProducts"
              className="group flex items-center gap-3 bg-white hover:bg-emerald-50 text-emerald-600 px-8 py-4 rounded-2xl font-bold mt-8 md:mt-0 transition-all duration-500 shadow-xl hover:shadow-emerald-500/25 transform hover:scale-105 border border-emerald-200"
            >
              Explore Trends
              ...
              {trendingPlans.map((plan, index) => (
                ...
                >
                  <div className="relative">
                    ...
                    {/* Trending indicator */}
                    <div className="absolute top-4 right-4 bg-gradient-to-r from-lime-500 to-emerald-500 text-white p-2 rounded-full shadow-lg animate-pulse">
                      <TrendingUp className="w-4 h-4" />
                    </div>
      ...
      <section className="relative bg-gradient-to-br from-emerald-900 via-emerald-800 to-lime-800 text-white py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-20">
            <span className="inline-block bg-white/20 backdrop-blur-xl px-6 py-3 rounded-full text-sm font-bold mb-6 border border-white/30">
              ⭐ CLIENT TESTIMONIALS
            </span>
            ...
            {[
              ...
              <div key={index} className="text-center group">
                <div className="flex items-center justify-center mb-4">
                  <div className="w-16 h-16 bg-white/10 backdrop-blur-xl rounded-2xl flex items-center justify-center border border-white/20 group-hover:scale-110 transition-transform duration-500">
                    <stat.icon className="w-8 h-8 text-lime-300" />
                  </div>
                </div>
      ...
      {/* CTA Section */}
      <section className="bg-white text-slate-800 py-20 overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-3 bg-white/60 backdrop-blur-md rounded-full px-6 py-3 mb-8 border border-lime-100 shadow-sm">
            ...
            <h2 className="text-4xl md:text-6xl font-bold mb-8 leading-tight text-emerald-500">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
              <Link
                to="/allProducts"
                className="group relative bg-gradient-to-r from-lime-500 to-emerald-500 hover:from-lime-400 hover:to-emerald-400 text-white px-12 py-6 rounded-2xl font-bold text-xl transition-all duration-500 shadow-2xl hover:shadow-lime-500/50 transform hover:scale-105 overflow-hidden"
              >
              ...
              <a
                ...
                className="group bg-white border border-emerald-300 hover:bg-lime-50 text-emerald-600 px-12 py-6 rounded-2xl font-bold text-xl transition-all duration-500 flex items-center justify-center gap-3 shadow-sm hover:shadow-md"
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {[
                ...
                <div key={index} className="group text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-lime-100 text-lime-700 rounded-2xl border border-lime-200 mb-4 group-hover:scale-110 transition-transform duration-500">
      ...
      {showVideo && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="relative bg-white rounded-3xl p-8 max-w-6xl w-full shadow-2xl border border-emerald-100">
            <button
              onClick={() => setShowVideo(false)}
              className="absolute top-6 right-6 w-12 h-12 bg-emerald-100 hover:bg-emerald-200 text-emerald-600 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
            >
              <X className="w-6 h-6" />
            </button>
